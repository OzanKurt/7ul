...
@section('content')
    <div class="container">
                ...
                <div class="content">
                    <form method="post" action="">
                        ...
                        <div class="input-group input-group-lg mb-3 mt-3">
                            <input autocomplete="off" type="text" required name="url" value="{{ old('url') }}" id="url" class="form-control{{ $errors->has('url') ? ' is-invalid' : '' }}" placeholder="{{ __('Link') }}">
                            <div class="input-group-append">
                                <button class="btn btn-primary" data-toggle="collapse" href="#collapseOptions" role="button" aria-expanded="false" aria-controls="collapseOptions" type="button">{{ __('Options') }}</button>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                        <label class="btn btn-sm btn-secondary">
                                            <input type="radio" checked name="private" value="1" id="privateNo"> {{ __('Public') }}
                                        </label>
                                        <label class="btn btn-sm btn-secondary">
                                            <input type="radio" name="private" value="0" id="privateYes"> {{ __('Private') }}
                                        </label>
                                    </div>
                                </div>
                            </div>
        ...
        <last-links-component></last-links-component>
    </div>
@endsection
